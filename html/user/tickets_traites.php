...
$tickets = getUTickets('Traité', $_SESSION['id_user']); // Récupérer les utilisateurs
?>

<div class="container-fluid">
    <div class="container-fluid">
        <h4 class="fw-semibold mb-4 justify-content-end">Tickets traités</h4>
        <hr>
...
<script>
  ...
  function applyTicketFilters() {
    ...
    fetch('controllers/ticket_controler.php?type_demande=' + typeDemande + '&type_équipement=' + typeEquipement + '&user=' + <?php echo $_SESSION['id_user'];?> + '&statut=Traité' )
        .then(response => response.json())
        .then(ticketsData => {
