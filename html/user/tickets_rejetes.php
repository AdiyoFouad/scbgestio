...
$tickets = getUTickets('Rejeté', $_SESSION['id_user']); // Récupérer les utilisateurs
?>

<div class="container-fluid">
    <div class="container-fluid">
        <h4 class="fw-semibold mb-4 justify-content-end">Tickets rejetés</h4>
        <hr>
                                    ...
                                    <tr onclick="remplirDetails('<?php echo $ticket['ref_ticket']; ?>')">
                                        ...
                                        <td class="border-bottom-0">
                                            <div class="d-flex align-items-center gap-2">
                                                <span class="badge bg-danger rounded-3 fw-semibold"><?= $ticket['statut']; ?></span>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
...
<script>
  ...
  function applyTicketFilters() {
    ...
    fetch('controllers/ticket_controler.php?type_demande=' + typeDemande + '&type_équipement=' + typeEquipement + '&user=' + <?php echo $_SESSION['id_user'];?> + '&statut=Rejeté' )
        .then(response => response.json())
        .then(ticketsData => {
