...
$tickets = getUTickets('En cours', $_SESSION['id_user']); // Récupérer les utilisateurs
?>
...
<script>
  ...
  function applyTicketFilters() {
    ...
    fetch('controllers/ticket_controler.php?type_demande=' + typeDemande + '&type_équipement=' + typeEquipement + '&user=' + <?php echo $_SESSION['id_user'];?> + '&statut=En cours' )
        .then(response => response.json())
        .then(ticketsData => {
