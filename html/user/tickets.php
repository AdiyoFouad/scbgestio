    ...
    <div class="row ">
      ...
      <div class="col-sm-5">
        <div class="card p-0">
          ...
          <h6 class="text-center fw-bolder">Détails du tickets</h6><hr>
          <span>Référence ticket :</span><br>
          <span>Utilisateur :</span><br>
          <span>Date de création du ticket :</span><br>
          <span>Type de demande :</span><br>
          <span>Statut du ticket :</span><br><hr>
          <h6 class="text-center fw-bolder">Détails sur l'équipement</h6><hr>
          <span>Type de l'équipement :</span><br>
          <span>Nom d'équipement :</span><br>
          <hr>
