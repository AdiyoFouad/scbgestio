      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="?page=stock" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="?page=consommables" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="?page=equipements" aria-expanded="false">
                ...
                <span class="hide-menu">Equipements assignés</span>
              </a>
            </li>
            <li class="sidebar-item">
